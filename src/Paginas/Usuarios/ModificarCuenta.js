  ...
  return (
    <div>
      ...
      <p>
        ...
        cuenta, etc. También bloquea y desbloquea una cuenta.
      </p>
      <ul className="list-group">
        <li className="list-group-item">
          <p>
            Estableceremos la fecha de expiración de la cuenta de usuario, para
            lo cual utilizaremos el parámetro –e
            <code>usermod –e [AAAA-MM-DD] + nombre de usuario</code>
            <img alt="imagen" src={Imagen1} />
            <p>
              La cuenta de usuario "carlos" expirará el 30 de Mayo del año 2021.
            </p>
          </p>
        </li>
        ...
        <li className="list-group-item">
          <p>
            Para cambiar el nombre de login de una cuenta de usuario, utilizamos
            el parámetro -l
            <code>
