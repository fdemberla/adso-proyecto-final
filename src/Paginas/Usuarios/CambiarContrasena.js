...
const CambiarContrasena = () => {
  return (
    <div>
      ...
      <Seccion
        parrafo={
          <p>
            ...
            la contraseña del usuario actual. Aquí cambiaremos la contraseña del
            usuario “chavez”; escribiendo <code>passwd chavez</code> y presiona
            Enter.
          </p>
        }
        imagen={Imagen1}
      ...
      <p>
        Observa como te pide la nueva contraseña y la confirmación de la misma.
        Este comando puedes usarlo con cualquier usuario. Ahora veremos algunas
        opciones ó parámetros que pueden ser usado con el comando passwd.
