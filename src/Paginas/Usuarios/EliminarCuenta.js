...
const EliminarCuenta = () => {
    return (
			<div>
				...
				<p>
					Si solo queremos eliminar la cuenta de usuario, sin importar que
					queden sus directorios y demás; utilizamos:{" "}
				</p>
				<code>userdel [nombre de usuario]</code>
				<img alt="imagen" src={Imagen1} />
				<p>
					Para eliminar una cuenta y su directorio, debemos emplear la opción
				</p>
                <code>userdel –r</code>
