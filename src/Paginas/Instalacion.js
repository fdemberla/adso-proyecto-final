    ...
    return (
			<div>
				...
				<h4>
					...
					inventado si estamos en una red domestica, sin embargo si estamos en
					una red corporativa donde si existe un nombre de dominio debemos
					asegurarnos de que este equipo tenga el mismo nombre de dominio que
					todos los equipos en la red.
				</h4>
				...
				<p>
					...
					administracion de sistema. Procurar seguir las sugerencias que nos da
					el instalador para hacer una contraseña segura, pues si esta
					contraseña es descifrada por algun intruso esta le dara control
					absoluto sobre nuestro sistema.
				</p>
				...
				<br />
				<h4>
					10. Si tenemos un disco con paquetes adicionales para instalar,
					podemos insertarlo y el instalador instalara los paquetes detectados,
					en este caso, no tenemos disco adicional, asi que continuamos con la
					instalacion normalmente.
				</h4>
				...
				<h4>15. GRUB</h4>
				<p>
					Como no hay otros sistemas operativos instalados, instalamos el
